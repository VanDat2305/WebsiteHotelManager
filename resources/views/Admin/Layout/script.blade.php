...
<script src="{{asset('bower_components/light-bootstrap-dashboard/assets/js/plugins/bootstrap-switch.js')}}"></script>
<!--  Google Maps Plugin    -->
...
<script src="{{asset('bower_components/light-bootstrap-dashboard/assets/js/plugins/bootstrap-notify.js')}}"></script>
